...
public class Corruption2Power : ThePrismatic2Power
{
    ...
    {
        if (card.Owner.Creature != Owner || card.Type != CardType.Skill || card.Keywords.Contains(Extensions.Keywords.Cunning) || card.Keywords.Contains(Extensions.Keywords.CunningThisTurn))
        {
