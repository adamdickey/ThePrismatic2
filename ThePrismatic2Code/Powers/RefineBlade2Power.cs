...
public class RefineBlade2Power : ThePrismatic2Power
{
	...
	protected override IEnumerable<IHoverTip> ExtraHoverTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromCard<RefineBlade2>());
