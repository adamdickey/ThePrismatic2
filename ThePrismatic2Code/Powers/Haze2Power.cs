...
public class Haze2Power : ThePrismatic2Power
{
	public override string CustomPackedIconPath => "Haze.png".PowerImagePath();
	public override string CustomBigIconPath => "Haze.png".BigPowerImagePath();

	protected override IEnumerable<IHoverTip> ExtraHoverTips => new _003C_003Ez__ReadOnlySingleElementList<IHoverTip>(HoverTipFactory.FromCard<Haze2>());
