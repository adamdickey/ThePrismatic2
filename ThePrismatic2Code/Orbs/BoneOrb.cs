...
public sealed class BoneOrb : CustomOrbModel
{
    ...
    public override Node2D? CreateCustomSprite()
    {
        ...
        // back layer: dark orb (white tint)
        ...
        dark.Modulate = new Color(0.95f, 0.95f, 0.95f, 1.0f);
        dark.Scale = new Vector2(1.1f, 1.1f);
        container.AddChild(dark);
        // front layer: glass orb (white core)
        ...
        new MegaSprite(glass.GetNode("SpineSkeleton"))
            .GetAnimationState().SetAnimation("idle_loop");
        glass.Modulate = new Color(0.95f, 0.95f, 0.95f, 1.0f);
