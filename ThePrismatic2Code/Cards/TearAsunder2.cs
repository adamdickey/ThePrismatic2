    ...
    TargetType.AnyEnemy)
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => new _003C_003Ez__ReadOnlyArray<DynamicVar>([
        ...
        new CalculatedVar("CalculatedHits").WithMultiplier((card, _) => 1 + CombatManager.Instance.History.Entries.OfType<DamageReceivedEntry>().Count(e => (e.Receiver == card.Owner.Creature || e.Receiver == card.Owner.Osty) && e.Result.UnblockedDamage > 0))
    ]);
