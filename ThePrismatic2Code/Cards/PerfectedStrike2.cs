    ...
    TargetType.AnyEnemy)
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => new _003C_003Ez__ReadOnlyArray<DynamicVar>([
        ...
        {
            if (card.Owner.PlayerCombatState != null) return card.Owner.PlayerCombatState.AllCards.Count(c => c.Tags.Contains(CardTag.Strike) || c.Keywords.Contains(Extensions.Keywords.Cunning) || c.Keywords.Contains(Extensions.Keywords.CunningThisTurn));
            return 0;
        })
    ]);
