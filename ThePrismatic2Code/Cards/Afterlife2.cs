...
public class Afterlife2() : ThePrismatic2Card(1, 
    ...
    TargetType.Self)
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => new _003C_003Ez__ReadOnlySingleElementList<DynamicVar>(new SummonVar(4m));
