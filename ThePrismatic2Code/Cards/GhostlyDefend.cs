    ...
    TargetType.Self)
{
        ...
        CardPlay play)
    {
        ...
        CardCmd.PreviewCardPileAdd(await CardPileCmd.AddGeneratedCardsToCombat(Soul.Create(base.Owner, 1, base.CombatState), PileType.Draw, addedByPlayer: true, CardPilePosition.Random));
    }
