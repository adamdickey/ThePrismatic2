    ...
    TargetType.Self)
{
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        await PowerCmd.Apply<CoolantPower>(choiceContext, Owner.Creature, DynamicVars["CoolantPower"].BaseValue, Owner.Creature, this);
    }

    protected override void OnUpgrade()
    {
        DynamicVars["CoolantPower"].UpgradeValueBy(1m);
    }
}